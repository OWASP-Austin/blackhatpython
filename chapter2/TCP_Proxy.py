...
receive_first helps us with this
'''
def server_loop(local_host, local_port, report_host, remote_port, receive_first):
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
        ...
        hexdump(remote_buffer)  # format it nicely
...
def receive_from(connection):
    ...
    # we set a second timout; depending on your
